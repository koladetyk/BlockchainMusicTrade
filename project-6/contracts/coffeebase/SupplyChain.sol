...
contract SupplyChain {
    ...
    function makeMusic(uint pupc, address pownerID, string _musicNotes) public {
      // Declare a variable of type MusicInfo
      MusicInfo memory musicInfo;

      musicInfo.musicID = sku + upc;
      musicInfo.musicNotes = _musicNotes;
        ...
        music[pupc] = Music({
            ...
            upc: pupc,
            ownerID: pownerID,
            originArtistID: pownerID,
            musicPrice: 0,
            musicState: State.Made,
            distributorID: address(0),
            recordLabelID: address(0),
            consumerID: address(0),
            musicInfo: musicInfo // Assign the musicInfo struct to the musicInfo property
        });
        // Increment sku
        sku = sku + 1;
    ...
    // Define a function 'promoteMusic' that allows an artist to mark music as 'Promoted'
    ...
    // Define a function 'distributeMusic' that allows an artist to mark music as 'Distributed'
